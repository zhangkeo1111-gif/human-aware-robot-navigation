...
described in the [reproducibility guide](docs/setup/REPRODUCIBILITY.md).
...
- [Documentation index](docs/README.md): setup, A300 system notes, and demonstration reports
